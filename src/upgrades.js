...
export const UPGRADES = [
  ...
  // ---------------------------------------------------------------- hazards
  {
    id: "bumperstone", name: "Bumper Stone", tag: "hazard", cost: 360,
  ...
  // ---------------------------------------------------------------- the hole
  {
    id: "lodestone", name: "Lodestone", tag: "hazard", cost: 450,
